...
export default class TimelineLoader {
  ...
  private createChunkLoader() {
    ...
    this.chunkLoader = new ChunkedRequest(this.relay.url, this.filters, this.log.extend("ChunkedRequest"));
  ...
  private openSubscription() {
    ...
    this.subscriptionSub = this.subscription.onEvent.subscribe((e) => this.handleEvent(e));
